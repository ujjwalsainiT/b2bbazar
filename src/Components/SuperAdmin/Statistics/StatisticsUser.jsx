...
function StatisticsUser(props) {

    //local state
    const classes = useStyles();
    const [page, setPage] = useState(0);
    const [rowsPerPage, setRowsPerPage] = useState(5);
    const [StatisticsUserArr] = useState([])
    ...
    return (
        <>
            <div className="content_padding">
                <div className="mb-3 page_heading">Statistics Users</div>
                    ...
                    <div className="table_foramtitng mt-2">
                        <TableContainer component={Paper}>
                            ...
                            <TablePagination
                                ...
                                component="div"
                                count={StatisticsUserArr.length}
...
export default HOC(StatisticsUser)
